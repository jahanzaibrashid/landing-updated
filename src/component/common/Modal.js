                ...
                <Dialog onClose={handleClose} aria-labelledby="customized-dialog-title" open={open}>
                    <Grid className={classes.ModalContainer} item>
                        <Grid container >
                            ...
                            <Grid item className={classes.ModalContainerItem}>
                                <Typography className={classes.ModalContainerItemTextTitle} variant="h4" gutterBottom align="center">
                                   What text to put here  ?
                                </Typography>
                                <Typography className={classes.ModalContainerItemTextParagraph} variant="p" gutterBottom>
                                I hereby confirm that I unconditionally accept and agree to comply with the Token Usage Agreement, the Terms of Use and the Privacy Policy (the “Legal Documents”). I understand that if I do not accept and agree to these Legal Documents, I acknowledge and agree that I shall immediately exit from and not access and/or use the platform.                             </Typography>
